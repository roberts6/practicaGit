...
// para descargar archivos desde el repositorio remoto al local (donde no tengo ningún archivo y quiero la última versión del repositorio en caso de estar trabajando en otra computadora o en equipo y alguien más haya hecho un cambio) vamos a ejecutar git clone + la url del repo que quiero descargar (ej: git clone https://github.com/roberts6/practicaGit.git). Este comando descarga una copia exacta de todos los archivos remotos en el repo local
// en caso de ya tener los archivos y querer actualizarlos vamos a usar git pull origin master. Esto lo que hace es actualizar los archivos que hayan sufrido cambios y bajar los nuevos.